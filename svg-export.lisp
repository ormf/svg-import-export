...
(defclass svg-file ()
  ((header :accessor header :initarg :header :initform *svg-header*)
   (elements :accessor elements :initarg :elements :initform nil)
   (last-id :accessor last-id :initarg :last-id :initform 1000)
   (group-ids :accessor group-ids :initarg :group-ids :initform nil)
   (layer-ids :accessor layer-ids :initarg :layer-ids :initform nil)
   (rect-ids :accessor rect-ids :initarg :rect-ids :initform nil)
   (point-ids :accessor point-ids :initarg :point-ids :initform nil)
   (line-ids :accessor rect-ids :initarg :rect-ids :initform nil)
   (text-ids :accessor text-ids :initarg :text-ids :initform nil)
   (clone-ids :accessor clone-ids :initarg :clone-ids :initform nil)
))
...
(defclass svg-point ()
  ((id :accessor id :initarg :id :initform 0)
   (cx :accessor cx :initarg :cx :initform 0)
   (cy :accessor cy :initarg :cy :initform 0)
   (rx :accessor rx :initarg :rx :initform 10)
   (ry :accessor ry :initarg :ry :initform 10)
   (fill-color :accessor fill-color :initarg :fill-color :initform "none")
   (fill-rule :accessor fill-rule :initarg :fill-rule :initform "evenodd")
   (fill-opacity :accessor fill-opacity :initarg :fill-opacity :initform 1)
   (stroke-color :accessor stroke-color :initarg :stroke-color :initform "#000000")
   (stroke-width :accessor stroke-width :initarg :stroke-width :initform 1)
   (stroke-linecap :accessor stroke-linecap :initarg :stroke-linecap :initform "butt")
   (stroke-linejoin :accessor stroke-linejoin :initarg :stroke-linejoin :initform "miter")
   (stroke-miterlimit :accessor stroke-miterlimit :initarg :stroke-miterlimit :initform 4)
   (stroke-dasharray :accessor stroke-dasharray :initarg :stroke-dasharray :initform "none")
   (stroke-opacity :accessor stroke-opacity :initarg :stroke-opacity :initform 1)))

(defclass svg-line ()
  ((id :accessor id :initarg :id :initform 0)
  (x1 :accessor x1 :initarg :x1 :initform 0)
  (y1 :accessor y1 :initarg :y1 :initform 0)
  (x2 :accessor x2 :initarg :x2 :initform 10)
  ...
  (stroke-linecap :accessor stroke-linecap :initarg :stroke-linecap :initform "butt")
  (stroke-linejoin :accessor stroke-linejoin :initarg :stroke-linejoin :initform "miter")
  (marker-end :accessor marker-end :initarg :marker-end :initform nil)
  (stroke-opacity :accessor stroke-opacity :initarg :stroke-opacity :initform 1)))
...
(defclass svg-rect ()
  ...
  (width :accessor width :initarg :width :initform 100)  
  (height :accessor height :initarg :height :initform 100)
  (stroke-color :accessor stroke-color :initarg :stroke-color :initform "#000000")
  (stroke-width :accessor stroke-width :initarg :stroke-width :initform 1)
  (stroke-linecap :accessor stroke-linecap :initarg :stroke-linecap :initform "butt")
  (stroke-linejoin :accessor stroke-linejoin :initarg :stroke-linejoin :initform "miter")
  ...
  (fill-color :accessor fill-color :initarg :fill-color :initform "none")
  (fill-rule :accessor fill-rule :initarg :fill-rule :initform "evenodd")
  (opacity :accessor opacity :initarg :opacity :initform 1)
  ))
...
(defclass svg-text ()
  ((id :accessor id :initarg :id :initform 0)
   ...
   (font-style :accessor font-style :initarg :font-style :initform "normal")
   (font-weight :accessor font-weight :initarg :font-weight :initform "normal")
   (fill-color :accessor fill-color :initarg :fill-color :initform "#000000")
   (fill-opacity :accessor fill-opacity :initarg :fill-opacity :initform 1)
   (stroke-color :accessor stroke-color :initarg :stroke-color :initform "none")
   (stroke-width :accessor stroke-width :initarg :stroke-width :initform 1)
   (stroke-linecap :accessor stroke-linecap :initarg :stroke-linecap :initform "butt")
   (stroke-linejoin :accessor stroke-linejoin :initarg :stroke-linejoin :initform "miter")
   (stroke-opacity :accessor stroke-opacity :initarg :stroke-opacity :initform 1)
   (font-family :accessor font-family :initarg :font-family :initform "Bitstream Vera Sans")
  ))

(defclass svg-layer ()
  ((id :accessor id :initarg :id :initform 0)
   (name :accessor name :initarg :name :initform "Ebene")))
...
(defclass svg-clone ()
  (
(id :accessor id :initarg :id :initform 0)
(href :accessor href :initarg :href :initform "")
(transform :accessor transform :initarg :transform :initform "matrix(1,0,0,1,0,0)")))
...
y x height width id fill-color fill-rule stroke-color stroke-width stroke-linecap stroke-linejoin stroke-opacity opacity))
...
(defun new-id (svg-file id-type &optional (id nil))
    (let ((curr (slot-value svg-file 'last-id)))
  (setf (slot-value svg-file id-type) 
        (cons
         (if id 
             (if (member id (slot-value svg-file id-type))
		 (error "id ~a already present in ~a" id id-type)
		 id)
	     (loop
                do (incf curr)
...
;; (let ((test (make-instance 'svg-file)))
;;    (new-id test 'group-ids "gen3")
;;    (new-id test 'clone-ids)
;;    (new-id test 'group-ids "gen2")
;;    (list
